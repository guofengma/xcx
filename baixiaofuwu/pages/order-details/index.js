...
Page({
    ...
    onShow : function () {
      var that = this;
      wx.request({
        url: 'https://oa.yudw.com/index.php?m=shop&c=order&a=detail&appid=' + APP_ID,
        data: {
      ...
      wx.showModal({
          ...
          success: function(res) {
            if (res.confirm) {
              wx.showLoading();
              wx.request({
                url: 'https://oa.yudw.com/index.php?m=shop&c=order&a=delivery&appid=' + APP_ID,
                data: {
                  token: app.globalData.token,
                  orderId: orderId
                },
    ...
    submitReputation: function (e) {
      ...
      wx.showLoading();
      wx.request({
        url: 'https://oa.yudw.com/index.php?m=shop&c=order&a=reputation&appid=' + APP_ID,
        data: {
